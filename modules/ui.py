...
def create_toprow(is_img2img):
    ...
    with gr.Row(elem_id="toprow"):
        ...
        with gr.Column(scale=1):
            ...
            with gr.Row(scale=1):
                if is_img2img:
                    interrogate = gr.Button('CLIP图像查询/Interrogate\nCLIP', elem_id="interrogate")
                    if cmd_opts.deepdanbooru:
                        deepbooru = gr.Button('DeepBooru图像查询/Interrogate\nDeepBooru', elem_id="deepbooru")
                    else:
                        deepbooru = None
                else:
                    interrogate = None
...
def create_ui(wrap_gradio_gpu_call):
    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Row():
                    batch_count = gr.Slider(minimum=1, step=1, label='生成次数/Batch count', value=1)
        ...
        with gr.Row().style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="预处理图像/Preprocess images"):
                    ...
                    process_height = gr.Slider(minimum=64, maximum=2048, step=64, label="高/Height", value=512)
    ...
    def Homejump():
        ...
        webbrowser.open('https://github.com/VinsonLaro/stable-diffusion-webui_chinese',new=0,autoraise=True)
